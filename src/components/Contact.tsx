      ...
      <div className="portfolio-container">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Vous avez un projet en tête ? Discutons-en ! Je suis disponible pour
            de nouveaux défis passionnants.
          </p>
        </motion.div>
          ...
          >
            <motion.div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Que ce soit pour un nouveau projet, une collaboration ou
                simplement échanger sur le développement web, n'hésitez pas à me
            ...
            >
              ...
              <p className="text-white/90 text-sm">
                Actuellement ouvert à de nouveaux projets freelance. Prochaine
